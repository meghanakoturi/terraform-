# main.tf #
Create a directory for your Terraform project and create a module name ami then Terraform configuration file named `main.tf' in that directory. In this file, you define the resource block
